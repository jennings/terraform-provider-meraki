...
type ClientService interface {
	...
	GetOrganizationDeviceStatuses(params *GetOrganizationDeviceStatusesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationDeviceStatusesOK, error)
...
/*
  GetOrganizationDeviceStatuses lists the status of every meraki device in the organization

  List the status of every Meraki device in the organization
*/
func (a *Client) GetOrganizationDeviceStatuses(params *GetOrganizationDeviceStatusesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetOrganizationDeviceStatusesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
