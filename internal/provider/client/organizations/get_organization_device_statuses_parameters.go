...
/* GetOrganizationDeviceStatusesParams contains all the parameters to send to the API endpoint
   for the get organization device statuses operation.
...
// WithDefaults hydrates default values in the get organization device statuses params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationDeviceStatusesParams) WithDefaults() *GetOrganizationDeviceStatusesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get organization device statuses params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationDeviceStatusesParams) SetDefaults() {
